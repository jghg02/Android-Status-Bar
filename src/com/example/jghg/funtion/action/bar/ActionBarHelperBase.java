...
public class ActionBarHelperBase extends ActionBarHelper {
	 ...
	 * {@link com.example.jghg.funtion.action.bar.android.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}
	 * .
	 */
	private View addActionItemCompatFromMenuItem(final MenuItem item) {
		...
		ImageButton actionButton = new ImageButton(mActivity, null,
				itemId == R.id.home ? R.attr.actionbarCompatItemHomeStyle
		...
		actionButton
				.setLayoutParams(new ViewGroup.LayoutParams(
						(int) mActivity
								.getResources()
								.getDimension(
										itemId == R.id.home ? R.dimen.actionbar_compat_button_home_width
